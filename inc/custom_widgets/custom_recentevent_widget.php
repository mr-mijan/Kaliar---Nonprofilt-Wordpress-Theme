<?php
class Kaliar_Latest_Event_Widget extends WP_Widget {

    // Constructor
    public function __construct() {
        parent::__construct(
            'kaliar_latest_event_widget',
            'Kaliar Latest Event',
            ...
            while ( $latest_posts->have_posts() ) {
               ...
               ?>
                <li class="mb-3">
                    ...
                    <div class="con fw-bolder"><span><?php echo get_the_date(); ?></span>
    ...
    function register_kaliar_custom_latest_event_widget() {
    register_widget( 'Kaliar_Latest_Event_Widget' );
    }
    add_action( 'widgets_init', 'register_kaliar_custom_latest_event_widget' );